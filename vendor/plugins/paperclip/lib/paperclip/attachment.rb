...
module Paperclip
  ...
  class Attachment
    ...
    def assign uploaded_file
      ...
      # modif perso post_process if valid? devient
      post_process if image?
      ...
      if image? and
         ...
         @instance.class.column_names.include?("#{name}_height") and
          @instance.class.column_names.include?("#{name}_dpih") and
          @instance.class.column_names.include?("#{name}_dpiw")
         ...
         begin
           ...
           instance_write(:dpih, geometry.dpih.to_i)
           instance_write(:dpiw, geometry.dpiw.to_i)
        ...
        instance_write(:dpih, nil)
        instance_write(:dpiw, nil)
      end
    ensure
